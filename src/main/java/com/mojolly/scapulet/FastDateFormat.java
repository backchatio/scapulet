...
public class FastDateFormat {
  ...
  public static final Integer LONG = new Integer(SimpleDateFormat.LONG);
  public static final Integer MEDIUM = new Integer(SimpleDateFormat.MEDIUM);
  public static final Integer SHORT = new Integer(SimpleDateFormat.SHORT);
    ...
    private static Map<TimeZoneDisplayKey, String> cTimeZoneDisplayCache = new HashMap<TimeZoneDisplayKey, String>();

    private static Map<Object, FastDateFormat> cInstanceCache = new HashMap<Object, FastDateFormat>(7);
    private static Map<Object, FastDateFormat> cDateInstanceCache = new HashMap<Object, FastDateFormat>(7);
    private static Map<Object, FastDateFormat> cTimeInstanceCache = new HashMap<Object, FastDateFormat>(7);
    private static Map<Object, FastDateFormat> cDateTimeInstanceCache = new HashMap<Object, FastDateFormat>(7);
        ...
        throws IllegalArgumentException
    {
        ...
        FastDateFormat format =
            cDateTimeInstanceCache.get(key);
        ...
        throws IllegalArgumentException
    {
        ...
        List<? extends Object> rulesList = parse(pattern, timeZone, locale, symbols);
